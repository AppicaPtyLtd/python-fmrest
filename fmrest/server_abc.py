...
class ServerABC(abc.ABC):
    ...
    def __init__(self, url: str, user: str,
        ...
        self.retry_get_record_on_not_found = retry_get_record_on_not_found
        self.retry_get_record_on_not_found_attempts = retry_get_record_on_not_found_attempts
        self.retry_get_record_on_not_found_delay = retry_get_record_on_not_found_delay
    ...
    def create_record_prepare_payload(self, layout: str, field_data: Dict[str, Any],
    ...
    @abc.abstractmethod
    def create_record(self, layout: str, field_data: Dict[str, Any],
                      portals: Optional[Dict[str, Any]] = None,
                      scripts: Optional[Dict[str, List]] = None) -> Optional[int]:
        raise NotImplementedError

    def edit_record_prepare_payload(self, layout: str, record_id: int, field_data: Dict[str, Any],
    ...
    def get_record_prepare_payload(self,
                                   layout: str,
                                   record_id: int,
    ...
    def upload_container_prepare_payload(self,
                                         layout: str,
                                         record_id: int,
                                         field_name: str,
                                         file_: IO) -> Dict:
    ...
    def get_records_prepare_payload(self,
                                    layout: str,
                                    offset: int = 1,
                                    limit: int = 100,
    ...
    def get_records_prepare_result(self, response: Dict, layout: str) -> Foundset:
    ...
    def find_prepare_result(self, layout: str, response: Dict) -> Foundset:
        info = response.get('dataInfo', {})
        return Foundset(self._process_foundset_response(response), info)
    ...
    def fetch_file_prepare_payload(self,
                                   layout: str,
                                   file_url: str,
    ...
    def fetch_file_prepare_result(self,
                                  layout: str,
                                  file_url: str,
                                  response: Any):
